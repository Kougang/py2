...
class Application(object): 
    ...
    def dessineResistance(self): 
        ...
        self.can = Canvas(self.root, width=250, height =100, bg ='red') 
        self.can.grid(row =1, column =1, columnspan =3, pady =5, padx =5) 
        
        # les deux fonctions ci dessous sont definies dans la bibiotheque de canvas
        
        self.can.create_line(10, 50, 240, 50, width =1) # fils
        self.can.create_rectangle(65, 30, 185, 70, fill ='greenyellow', width =2) 
